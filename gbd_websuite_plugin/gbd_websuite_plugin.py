...
class gbdWebsuite:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('gbdWebsuite', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/gbd_websuite_plugin/icons/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'GBD WebSuite Manager'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD gbdWebsuite"

        ######
        #self.dockwidget.clear_Plugin()
        ######

        
        for action in self.actions:
            self.iface.removePluginWebMenu(
                self.tr(u'&GBD WebSuite'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = gbdWebsuiteDockWidget()
